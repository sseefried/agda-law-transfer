...
open import LawTransfer
open LawTransfers ⟦_⟧ _≡_

ringLawTransfer : RingLawTransfer (record { _+_ = _xor′_ ; _*_ = _∧′_ ; -_ = id; 0# = false′ ; 1# = true′ }) _  ⦃ ⊕-∧-isRing ⦄
ringLawTransfer =
  record
...
parityIsRing = RingLawTransfer.isRing-trans ⦃ ⊕-∧-isRing ⦄ ringLawTransfer
